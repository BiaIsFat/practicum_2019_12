...
<div class="container1">
 ...
 <div class="link1">
  ...
  -->
   <div class="link1">
    <div class="text"><a href="cinemainfo.jsp">修改影院信息</a></div>
</div>
  <div class="link1">
...
<form action="sessionseat/updateSession.do" method="post" class="niceform">
	<fieldset>
    	<legend>Select Session</legend>
            <input type="hidden" name="sno" value="${requestScope.session.sno }">
        <dl>
    	  <dt><label for="fname">电影名称:</label></dt>
        	<dd><label for="fnamae">${requestScope.session.film.fname }</label></dd>
        </dl>

              <dl>
        	<dt><label for=begin_time">开场时间:</label></dt>
            <dd><input type="text" name="begin_time" id="begin_time" size="32" maxlength="128" value="${requestScope.session.begin_time }"/></dd>
        </dl>
    
                 <dl>
        	<dt><label for="end_time">票价:</label></dt>
        	<dd><label for="end_time"><input type="text" name="price" id="begin_time" size="10" value="${requestScope.session.price }"></label></dd>
        </dl>
    
     <dl>
                    <!--  
        	<dt><label for="rname">影厅类别</label></dt>
            <dd>
            	<select size="1" name="rname" id="rname">           	
