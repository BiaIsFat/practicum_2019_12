...
.wz2{ font-weight: 600;font-size: 26px;color:black;text-align:center;margin-top:10%;}
...
<div class="container">
  ...
  <div class="link">
    <div class="text">联系我们</div>
       ...
       <div class="main1">
       <table class="wz2"><tr><td colspan="2"> 个人资料</td></tr>

<tr> <td colspan="2">亲爱的</td></tr>
<tr></tr>
<tr></tr>
<tr> <td>当前的昵称</td><td> --<%=user.getUname() %>--</td></tr>
<tr> <td>性别：</td><td> <%=user.getSex() %></td></tr>
<tr> <td>邮箱：</td><td> <%=user.getEmail() %></td></tr>
<tr> <td>电话：</td><td> <%=user.getUphone() %></td></tr>
</table>
