...
<div class="container1">
 ...
 <form action="cinema/addCinema.do">
 <table class="wz2">
 
<tr><td colspan="4" >增加影院 </td></tr>
<tr><td>请填写如下表单</td></tr>
<tr><td colspan="3" >-------------------------------------------------------------------</td></tr>
<tr> <td  width="200px" >影院名称</td><td colspan="2" width="300px"> <input type="text" name="cname" class="tab"/></td></tr>
<tr> <td width="200px">地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址</td><td colspan="2" width="300px"> <input type="text"  name="addr" class="tab"/></td></tr>
<tr> <td width="200px">营业时间</td><td colspan="2" width="300px"> <input type="text"  name="worktime" class="tab"/></td></tr>
<tr> <td width="200px">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话</td><td colspan="2" width="300px"> <input type="text"  name="tel" class="tab"/></td></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr><td colspan="3" >-------------------------------------------------------------------</td></tr>
<tr> <td> <input type="submit" value="确认提交" style="border-radius:5px;background-color:#CC3333;color:#fff" /></td></tr>
</table>
</form>
       </div></div>
