...
.wz2{margin-left:1%;margin-top:5%; font-weight: 800;font-size: 18px;color:black;
text-align:center;
...
<div class="container1">
 ...
 <div class="link">
  ...
  <div class="link">
   ...
   <div class="link">
    <div class="text"><a href="cinemainfo.jsp">影院信息</a></div>
  </div>
  <div class="link">
...
<tr> <td width="200px"><i class="fa fa-minus-square" aria-hidden="true"></i>    <%=cinema.getCname() %></td><td colspan="3" width="300px"> 
<input type="submit"  value=" 删除 " style="border-radius:5px;background-color:#CC3333;color:#fff"/>
</td></tr>

<!-- <tr> <td width="200px"><i class="fa fa-minus-square" aria-hidden="true"></i> </td><td colspan="3" width="300px"> 
<input type="submit"  value=" 删除 " style="border-radius:5px;background-color:#CC3333;color:#fff"/>

</td></tr>

<tr> <td width="200px"><i class="fa fa-minus-square" aria-hidden="true"></i>    美岁大地影院</td><td colspan="3" width="300px"> 
<input type="submit"  value=" 删除 " style="border-radius:5px;background-color:#CC3333;color:#fff";οnclick="return sumbit_form()"
/>
